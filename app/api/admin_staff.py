...
def staff_list(request: Request, db: Session = Depends(get_db), staff: StaffUser = Depends(require_staff)):
    ...
    return templates.TemplateResponse(
        ...
        admin_ctx(request, staff, users=users, tokens_by_user=tokens_by_user, me=staff),
    )
...
def create_staff(
    ...
    try:
        staff_auth.create_or_update_staff_user(db, email=email, name=name, password=password, role=role)
